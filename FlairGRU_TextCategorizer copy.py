...
embedding = DocumentRNNEmbeddings([glove_embedding], hidden_size=512, reproject_words=True, reproject_words_dimension=256, rnn_type = 'GRU')
...
# start training
trainer.train('/home/thiesen/Projects/Flair NLP/GRU_TextCategorizer', 
              learning_rate=0.1,
              mini_batch_size=32,
              max_epochs=10)