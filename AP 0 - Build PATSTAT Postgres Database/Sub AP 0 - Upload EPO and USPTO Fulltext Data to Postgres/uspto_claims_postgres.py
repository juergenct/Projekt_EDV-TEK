...
def process_upload_tsv(file_path):
    ...
    df['publn_auth'] = 'US'
    df.to_sql('us_claims', con=engine, if_exists='append', index=False)
...
df_errors.to_csv('/mnt/hdd01/patentsview/Fulltext Data/Claims/PATSTAT_2023_parsing_errors.csv', index=False)
