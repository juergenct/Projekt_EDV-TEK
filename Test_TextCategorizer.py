...
model_path = '/Users/juergenthiesen/Documents/USPTO Data/Full Text Bulk Data USPTO 02_23 Preprocessed/JSON_Cleantech_trainingdata/Flair Model/Distilbert_TextCategorizer/best-model.pt'
model = TextClassifier.load(model_path)

''' Testing the model on test data '''
# Load the data
df_USPTO = pd.read_json('/Users/juergenthiesen/Documents/USPTO Data/Full Text Bulk Data USPTO 02_23 Preprocessed/JSON_Cleantech_trainingdata/Flair Model/USPTO_Cleantech_Non_Cleantech_2013_2023_regex_test.json')
