...
from transformers import AutoModel; AutoModel.from_pretrained('climatebert/distilroberta-base-climate-f')
...
embedding = TransformerDocumentEmbeddings('climatebert/distilroberta-base-climate-f')
...
# start training
trainer.train('/home/thiesen/Projects/Flair NLP/ClimateBert_TextCategorizer', 
              learning_rate=0.1,
              mini_batch_size=32,
              max_epochs=10)