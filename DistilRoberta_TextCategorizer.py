...
from transformers import AutoModel; AutoModel.from_pretrained('distilroberta-base')
...
# start training
trainer.train('/home/thiesen/Projects/Flair NLP/distilroberta-base_TextCategorizer', 
              learning_rate=0.1,
              mini_batch_size=32,
              max_epochs=10)